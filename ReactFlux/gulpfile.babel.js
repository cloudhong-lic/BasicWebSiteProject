...
gulp.task('webpack-dev', () => gulp.src('./scripts/**/*.jsx')
  .pipe(stream(webpackConfigDev))
  .pipe(gulp.dest('dist/scripts')));

gulp.task('webpack-prod', () => gulp.src('./scripts/**/*.jsx')
...
gulp.task('static', () => {
  gulp.src('./scripts/fonts/**/*.*')
    .pipe(gulp.dest('./dist/fonts'));
  gulp.src('./scripts/images/**/*.*')
    .pipe(gulp.dest('./dist/images'));
  gulp.src('./scripts/page/**/*.*')
    .pipe(gulp.dest('./dist'));
});
...
gulp.task('watch', () => {
  ...
  gulp.watch('./scripts/**/*.js', ['webpack-dev']);
  gulp.watch('./scripts/**/*.jsx', ['webpack-dev']);
});
